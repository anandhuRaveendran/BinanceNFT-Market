...
contract BinanceNFT is ERC721, Ownable {
    struct Sale {
        address seller;
        uint256 price;
        bool isForSale;
    ...
    constructor() ERC721("BinanceNFT", "BNF") Ownable(msg.sender) {}

    function _baseURI() internal pure override returns (string memory) {
        return
            "https://black-defensive-quelea-16.mypinata.cloud/ipfs/QmTqJQg9rjFWZrqn67uaB87voQbdjTDk86RUr68gAsknsH";
    }
